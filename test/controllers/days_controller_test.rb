...
class DaysControllerTest < ActionController::TestCase
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post :create, day: { cost: @day.cost, description: @day.description, image: @day.image, link: @day.link, name: @day.name, trip_id: @day.trip_id }
    end
  ...
  test "should update day" do
    patch :update, id: @day, day: { cost: @day.cost, description: @day.description, image: @day.image, link: @day.link, name: @day.name, trip_id: @day.trip_id }
    assert_redirected_to day_path(assigns(:day))
  end
